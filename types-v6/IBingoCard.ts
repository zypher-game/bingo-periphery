...
export interface IBingoCardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addMinter"
      | "bindCardGame"
...
export interface IBingoCard extends BaseContract {
  connect(runner?: ContractRunner | null): IBingoCard;
  ...
  calculateMatchedLineCounts: TypedContractMethod<
    [cardNumbers: BigNumberish[][], encodedSelectNumbers: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  decodeSelectedNumbers: TypedContractMethod<
    [encodedSelectedNumbers: BigNumberish],
    [bigint[]],
    "view"
  >;
