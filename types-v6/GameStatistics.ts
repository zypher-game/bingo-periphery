...
export interface GameStatisticsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface GameStatistics extends BaseContract {
  connect(runner?: ContractRunner | null): GameStatistics;
