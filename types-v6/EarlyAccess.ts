...
export interface EarlyAccessInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface EarlyAccess extends BaseContract {
  connect(runner?: ContractRunner | null): EarlyAccess;
  waitForDeployment(): Promise<this>;

  interface: EarlyAccessInterface;
