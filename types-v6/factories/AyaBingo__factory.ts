...
import type { AyaBingo, AyaBingoInterface } from "../AyaBingo";
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct AyaBingo.Selection[]",
        name: "selections",
        type: "tuple[]",
      },
      {
...
export class AyaBingo__factory {
  static readonly abi = _abi;
  static createInterface(): AyaBingoInterface {
    return new Interface(_abi) as AyaBingoInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): AyaBingo {
    return new Contract(address, _abi, runner) as unknown as AyaBingo;
  }
}
