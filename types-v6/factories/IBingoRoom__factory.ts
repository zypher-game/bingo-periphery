...
export class IBingoRoom__factory {
  ...
  static createInterface(): IBingoRoomInterface {
    return new Interface(_abi) as IBingoRoomInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IBingoRoom {
    return new Contract(address, _abi, runner) as unknown as IBingoRoom;
  }
}
