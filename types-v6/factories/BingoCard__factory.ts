...
export class BingoCard__factory {
  ...
  static createInterface(): BingoCardInterface {
    return new Interface(_abi) as BingoCardInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): BingoCard {
    return new Contract(address, _abi, runner) as unknown as BingoCard;
  }
}
