...
export interface AiZkLobbyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "NAME"
      | "RECENT_GAME_COUNTS"
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, AiZkBingoRoom.SelectionStruct[], BytesLike]
  ): string;
  encodeFunctionData(
...
export interface AiZkLobby extends BaseContract {
  connect(runner?: ContractRunner | null): AiZkLobby;
  ...
  batchSelectNumber: TypedContractMethod<
    [
      gameId: BigNumberish,
      selections: AiZkBingoRoom.SelectionStruct[],
      batchProof: BytesLike
  ...
  report: TypedContractMethod<[gameId: BigNumberish], [bigint], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "batchSelectNumber"
  ): TypedContractMethod<
    [
      gameId: BigNumberish,
      selections: AiZkBingoRoom.SelectionStruct[],
