...
import type { AyaBingoRoom, AyaBingoRoomInterface } from "../AyaBingoRoom";
...
export class AyaBingoRoom__factory {
  static readonly abi = _abi;
  static createInterface(): AyaBingoRoomInterface {
    return new utils.Interface(_abi) as AyaBingoRoomInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AyaBingoRoom {
    return new Contract(address, _abi, signerOrProvider) as AyaBingoRoom;
  }
}
