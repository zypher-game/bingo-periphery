...
export interface AiZkLobbyInterface extends utils.Interface {
  functions: {
...
export type BatchSelectedEvent = TypedEvent<
  [BigNumber, AiZkBingoRoom.SelectionStructOutput[], string],
...
export interface AiZkLobby extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AiZkLobbyInterface;
